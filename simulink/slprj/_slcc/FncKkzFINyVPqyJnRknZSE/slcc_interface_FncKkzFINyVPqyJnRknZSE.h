...
DLL_EXPORT_CC extern int32_T init_can_FncKkzFINyVPqyJnRknZSE(real_T maxSpeed, real_T maxAccel);
...
DLL_EXPORT_CC extern void stop_motor_FncKkzFINyVPqyJnRknZSE(void);
