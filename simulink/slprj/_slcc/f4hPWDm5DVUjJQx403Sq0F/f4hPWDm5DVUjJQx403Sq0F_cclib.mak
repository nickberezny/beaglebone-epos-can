...
LDFLAGS   =  -s -dll -entry LibMain f4hPWDm5DVUjJQx403Sq0F_cclib.def -L"C:\Program Files\MATLAB\R2022b\sys\lcc64\lcc64\lib64"
...
f4hPWDm5DVUjJQx403Sq0F_cclib.dll : $(MAKEFILE) $(OBJECTS)
	$(LD) $(LDFLAGS) /OUT:f4hPWDm5DVUjJQx403Sq0F_cclib.dll $(OBJECTS)  $(STATICLIBS) "C:\Program Files\MATLAB\R2022b\extern\lib\win64\microsoft\libmex.lib" "C:\Program Files\MATLAB\R2022b\extern\lib\win64\microsoft\libmx.lib"
