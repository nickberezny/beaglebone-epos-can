...
#define S_FUNCTION_NAME                controller_cgxe
#include "simstruc.h"
...
static void mdlStart(SimStruct* S)
{
  ...
  success = cgxe_controller_method_dispatcher(S, SS_CALL_MDL_START, NULL);
  if (!success) {
    /* error */
...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 2381794144;
  checksumData[1] = 3574268267;
  checksumData[2] = 2091662815;
  checksumData[3] = 1800821273;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 2599838837;
    checksumData[1] = 4166191584;
    checksumData[2] = 1303398351;
    checksumData[3] = 1245493436;
  ...
  mxArray * prhs[])
{
  ...
  success = cgxe_controller_method_dispatcher(S, SS_CALL_MDL_GET_SIM_STATE,
    (void *) (plhs));
  if (!success) {
    /* error */
    mexPrintf("ERROR: Failed to dispatch s-function method!\n");
  ...
  mxArray * prhs[])
{
  unsigned int success;
  SimStruct *S = cgxe_unpack_simstruct(prhs[1]);
  success = cgxe_controller_method_dispatcher(S, SS_CALL_MDL_SET_SIM_STATE,
    (void *) prhs[2]);
  if (!success) {
    /* error */
    mexPrintf("ERROR: Failed to dispatch s-function method!\n");
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "ruThg8ilLzfH7h2KmGFzOE") == 0) {
    extern mxArray *cgxe_ruThg8ilLzfH7h2KmGFzOE_BuildInfoUpdate(void);
    plhs[0] = cgxe_ruThg8ilLzfH7h2KmGFzOE_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "ruThg8ilLzfH7h2KmGFzOE") == 0) {
    extern mxArray *cgxe_ruThg8ilLzfH7h2KmGFzOE_fallback_info(void);
    plhs[0] = cgxe_ruThg8ilLzfH7h2KmGFzOE_fallback_info();
    return 1;
  }
