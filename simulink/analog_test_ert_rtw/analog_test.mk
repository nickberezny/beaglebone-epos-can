###########################################################################
## Makefile generated for component 'analog_test'. 
## 
## Makefile     : analog_test.mk
## Generated on : Fri Sep 22 15:09:23 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/analog_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/analog_test.elf
...
DEFINES_STANDARD = -DMODEL=analog_test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_digitalIO.c analog_test.c analog_test_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_digitalIO.c.o analog_test.c.o analog_test_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
analog_test.c.o : analog_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


analog_test_data.c.o : analog_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
