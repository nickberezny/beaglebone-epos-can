...
static creal_T controller_times(const creal_T b_a)
{
  ...
  controller_B.ahi_b = c.re;
  if (controller_B.b != 0.0) {
    controller_B.alo_c = c.im + controller_B.b;
    controller_B.ahi_b = c.re + controller_B.alo_c;
    controller_B.alo_c -= controller_B.ahi_b - c.re;
  }
...
static creal_T controller_plus(const creal_T b_a, real_T b)
{
  ...
  if (controller_B.t_c.re != 0.0) {
    controller_B.alo_p = c.im + controller_B.t_c.re;
  ...
  b_ahi = controller_B.ahi_c;
  if (controller_B.t_c.im != 0.0) {
    controller_B.alo_p += controller_B.t_c.im;
    b_ahi = controller_B.ahi_c + controller_B.alo_p;
    controller_B.alo_p -= b_ahi - controller_B.ahi_c;
  }
...
static creal_T controller_minus(const creal_T b_a, const creal_T b)
{
  ...
  b_ahi = controller_B.ahi;
  if (controller_B.t_m.im != 0.0) {
    controller_B.alo += controller_B.t_m.im;
    b_ahi = controller_B.ahi + controller_B.alo;
    controller_B.alo -= b_ahi - controller_B.ahi;
  }
...
void controller_step(void)
{
...

  {
    ...
    if (controller_M->Timing.TaskCounters.TID[3] == 0) {
       ...
       */
      controller_B.Gain = floor(controller_P.Constant14_Value_c);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
      }

      /* DataTypeConversion: '<Root>/Data Type Conversion2' incorporates:
       *  DataStoreRead: '<Root>/Data Store Read9'
       */
      controller_B.DataStoreRead8 = floor(controller_DW.debug);
       ...
       */
      print_input(controller_DW.state, controller_B.Gain < 0.0 ? -(int32_T)
                  (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                  controller_B.Gain, controller_B.DataStoreRead8 < 0.0 ?
                  -(int32_T)(uint32_T)-controller_B.DataStoreRead8 : (int32_T)
                  (uint32_T)controller_B.DataStoreRead8);
      ...
      if (controller_B.DataStoreRead1_c == controller_P.CompareToConstant2_const)
      {
        ...
        if (controller_M->Timing.TaskCounters.TID[5] == 0) {
           ...
           */
          controller_B.Gain = floor(controller_DW.num_motors);
          if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
            controller_B.Gain = 0.0;
          } else {
            controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
           ...
           */
          init_can(controller_B.Gain < 0.0 ? -(int32_T)(uint32_T)
                   -controller_B.Gain : (int32_T)(uint32_T)controller_B.Gain,
    ...
    if (controller_DW.Home1_MODE) {
       ...
       */
      get_encoder(controller_DW.pdo_id, controller_B.Gain < 0.0 ? -(int32_T)
                  (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                  controller_B.Gain, &controller_B.CCaller1_k[0]);

      /* RelationalOperator: '<S12>/Compare' incorporates:
       *  Constant: '<S12>/Constant'
       */
      rtb_Compare_p_idx_0 = (controller_B.CCaller1_k[0] !=
      ...
      controller_DW.q01 = controller_B.Gain2_o[0];
      ...
      controller_B.Gain = controller_M->Timing.t[0];
      if ((controller_DW.TimeStampA_f >= controller_B.Gain) &&
          (controller_DW.TimeStampB_o >= controller_B.Gain)) {
        /* Derivative: '<S7>/Derivative' */
        controller_B.Derivative_e[0] = 0.0;
        controller_B.Derivative_e[1] = 0.0;
      } else {
        controller_B.DataStoreRead8 = controller_DW.TimeStampA_f;
        lastU = &controller_DW.LastUAtTimeA_e;
        if (controller_DW.TimeStampA_f < controller_DW.TimeStampB_o) {
          if (controller_DW.TimeStampB_o < controller_B.Gain) {
            controller_B.DataStoreRead8 = controller_DW.TimeStampB_o;
            lastU = &controller_DW.LastUAtTimeB_h;
          }
        } else if (controller_DW.TimeStampA_f >= controller_B.Gain) {
          controller_B.DataStoreRead8 = controller_DW.TimeStampB_o;
          lastU = &controller_DW.LastUAtTimeB_h;
        }

        controller_B.DataStoreRead8 = controller_B.Gain -
          controller_B.DataStoreRead8;

        /* Derivative: '<S7>/Derivative' */
        controller_B.Derivative_e[0] = (controller_B.Gain2_o[0] - (*lastU)[0]) /
          controller_B.DataStoreRead8;
        controller_B.Derivative_e[1] = (controller_B.Gain2_o[1] - (*lastU)[1]) /
          controller_B.DataStoreRead8;
      }
       ...
       */
      controller_B.Gain = floor(controller_P.Constant14_Value);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
       ...
       */
      print_input(controller_B.Derivative_e[0], controller_B.Gain < 0.0 ?
                  -(int32_T)(uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                  controller_B.Gain, controller_B.DataStoreRead8 < 0.0 ?
                  -(int32_T)(uint32_T)-controller_B.DataStoreRead8 : (int32_T)
                  (uint32_T)controller_B.DataStoreRead8);
      ...
      controller_B.Saturation_d = (controller_P.Constant1_Value_i -
        controller_B.Derivative_e[0]) * controller_P.Gain3_Gain -
       ...
       */
      controller_B.Gain = floor(controller_P.Constant_Value_c);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
       ...
       */
      set_motor(controller_DW.pdo_id, controller_B.Gain < 0.0 ? -(int32_T)
                (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                controller_B.Gain, controller_B.Saturation_d);
    ...
    if (controller_DW.Home2_MODE) {
      ...
      if (rtb_Compare_m) {
         ...
         */
        controller_DW.state = controller_P.Constant1_Value_a;
      }
      ...
      if (rtb_Compare_p_idx_0) {
        /* Switch: '<S8>/Switch' */
        controller_B.Switch[0] = controller_B.CCaller1_k[0];
      } else {
      ...
      if (rtb_Compare_p_idx_1) {
        /* Switch: '<S8>/Switch' */
        controller_B.Switch[1] = controller_B.CCaller1_k[1];
      } else {
        /* Switch: '<S8>/Switch' incorporates:
         *  Delay: '<S8>/Delay'
         */
       ...
       *  Product: '<S8>/Divide'
       */
      controller_B.Gain2_a[0] = controller_B.Switch[0] /
        (controller_P.Gain_Gain_o * controller_DW.GR1) *
        controller_P.Gain2_Gain_p;
      controller_B.Gain2_a[1] = controller_B.Switch[1] /
        (controller_P.Gain1_Gain_d * controller_DW.GR2) *
        controller_P.Gain2_Gain_p;

      /* Derivative: '<S8>/Derivative' */
      controller_B.Gain = controller_M->Timing.t[0];
      if ((controller_DW.TimeStampA_gc >= controller_B.Gain) &&
          (controller_DW.TimeStampB_h >= controller_B.Gain)) {
        /* Derivative: '<S8>/Derivative' */
        controller_B.Derivative_i[0] = 0.0;
        controller_B.Derivative_i[1] = 0.0;
      } else {
        controller_B.DataStoreRead8 = controller_DW.TimeStampA_gc;
        lastU = &controller_DW.LastUAtTimeA_f;
        if (controller_DW.TimeStampA_gc < controller_DW.TimeStampB_h) {
          if (controller_DW.TimeStampB_h < controller_B.Gain) {
            controller_B.DataStoreRead8 = controller_DW.TimeStampB_h;
            lastU = &controller_DW.LastUAtTimeB_c;
          }
        } else if (controller_DW.TimeStampA_gc >= controller_B.Gain) {
          controller_B.DataStoreRead8 = controller_DW.TimeStampB_h;
          lastU = &controller_DW.LastUAtTimeB_c;
        }
        ...
        /* Derivative: '<S8>/Derivative' */
        controller_B.Derivative_i[0] = (controller_B.Gain2_a[0] - (*lastU)[0]) /
          controller_B.DataStoreRead8;
        controller_B.Derivative_i[1] = (controller_B.Gain2_a[1] - (*lastU)[1]) /
          controller_B.DataStoreRead8;
      }
       ...
       */
      controller_B.Gain = floor(controller_P.Constant14_Value_m);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
       ...
       */
      print_input(controller_B.Derivative_i[0], controller_B.Gain < 0.0 ?
                  -(int32_T)(uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                  controller_B.Gain, controller_B.DataStoreRead8 < 0.0 ?
                  -(int32_T)(uint32_T)-controller_B.DataStoreRead8 : (int32_T)
                  (uint32_T)controller_B.DataStoreRead8);
      ...
      controller_B.Saturation = (controller_P.Constant3_Value -
        controller_B.Derivative_i[0]) * controller_P.Gain3_Gain_n -
        controller_P.Constant_Value_b;

      /* Saturate: '<S8>/Saturation' */
      if (controller_B.Saturation > controller_P.Saturation_UpperSat_n) {
        /* Sum: '<S8>/Sum2' incorporates:
         *  Saturate: '<S8>/Saturation'
         */
        controller_B.Saturation = controller_P.Saturation_UpperSat_n;
      } else if (controller_B.Saturation < controller_P.Saturation_LowerSat_h) {
        /* Sum: '<S8>/Sum2' incorporates:
         *  Saturate: '<S8>/Saturation'
         */
        controller_B.Saturation = controller_P.Saturation_LowerSat_h;
      }
       ...
       */
      controller_B.Gain = floor(controller_P.Constant2_Value_k);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
      ...
      set_motor(controller_DW.pdo_id, controller_B.Gain < 0.0 ? -(int32_T)
                (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                controller_B.Gain, controller_B.Saturation);
    ...
    if (controller_DW.MainControl_MODE) {
      ...
      get_encoder(controller_DW.pdo_id, controller_B.Gain < 0.0 ? -(int32_T)
                  (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                  controller_B.Gain, &controller_B.CCaller1);

      /* RelationalOperator: '<S24>/Compare' incorporates:
       *  Constant: '<S24>/Constant'
       */
      rtb_Compare_n1 = (controller_B.CCaller1 != controller_P.Constant_Value_p);

      /* RelationalOperator: '<S10>/IsNaN' */
      rtb_Compare_p_idx_0 = rtIsNaN(controller_B.CCaller1);

      /* Logic: '<S10>/Logical Operator1' incorporates:
       *  Logic: '<S10>/Logical Operator'
       */
      controller_B.LogicalOperator1 = (rtb_Compare_n1 && (!rtb_Compare_p_idx_0));

      /* Switch: '<S10>/Switch' */
      if (controller_B.LogicalOperator1) {
        /* Sum: '<S10>/Sum' incorporates:
         *  Switch: '<S10>/Switch'
         */
        controller_B.Gain2[0] = controller_B.CCaller1 -
          controller_B.DataStoreRead1_c;
        controller_B.Gain2[1] = controller_B.CCaller1 -
          controller_B.DataStoreRead8;
      } else {
        controller_B.Gain2[0] = 0.0;
        controller_B.Gain2[1] = 0.0;
      }
       ...
       */
      controller_B.Gain = controller_P.Gain_Gain_m * controller_DW.GR1;

      /* Gain: '<S10>/Gain2' incorporates:
       *  Product: '<S10>/Divide'
       *  Switch: '<S10>/Switch'
       */
      controller_B.Gain2[0] = controller_B.Gain2[0] / controller_B.Gain *
        controller_P.Gain2_Gain_b;
      controller_B.Gain2[1] = controller_B.Gain2[1] / controller_B.Gain *
        controller_P.Gain2_Gain_b;
      if (controller_M->Timing.TaskCounters.TID[2] == 0) {
        /* DataTypeConversion: '<S10>/Data Type Conversion4' incorporates:
         *  Constant: '<S10>/Constant1'
         */
        controller_B.Gain = floor(controller_P.Constant1_Value_j);
        if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
          controller_B.Gain = 0.0;
        } else {
          controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
         ...
         */
        print_input(controller_B.Gain2[0], controller_B.Gain < 0.0 ? -(int32_T)
                    (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                    controller_B.Gain, controller_B.DataStoreRead8 < 0.0 ?
                    -(int32_T)(uint32_T)-controller_B.DataStoreRead8 : (int32_T)
                    (uint32_T)controller_B.DataStoreRead8);
         ...
         */
        controller_B.Gain = floor(controller_P.Constant14_Value_g);
        if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
          controller_B.Gain = 0.0;
        } else {
          controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
         ...
         */
        print_input(controller_B.CCaller1, controller_B.Gain < 0.0 ? -(int32_T)
                    (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                    controller_B.Gain, controller_B.DataStoreRead8 < 0.0 ?
                    -(int32_T)(uint32_T)-controller_B.DataStoreRead8 : (int32_T)
                    (uint32_T)controller_B.DataStoreRead8);
      ...
      controller_getLocalTime(&controller_B.fracSecs, &controller_B.second,
        &controller_B.Gain, &controller_B.DataStoreRead1_c,
        &controller_B.DataStoreRead8, &controller_B.c_tm_mon,
      ...
      controller_B.check = (((((controller_B.c_tm_year + controller_B.c_tm_mon)
        + controller_B.DataStoreRead8) + controller_B.DataStoreRead1_c) +
        controller_B.Gain) + controller_B.second) + controller_B.fracSecs;
      if ((!rtIsInf(controller_B.check)) && (!rtIsNaN(controller_B.check))) {
        ...
        controller_B.d_data.re = ((((((365.0 * controller_B.c_tm_year + floor
          ...
          controller_B.c_tm_mon + 2.0) / 5.0)) + controller_B.DataStoreRead8) +
          60.0) - 719529.0;
        ...
        controller_B.d_data = controller_plus(controller_plus(controller_plus
          ...
          controller_B.DataStoreRead1_c + controller_B.Gain) * 60000.0),
      ...
      controller_B.c_s.im = (controller_B.c_s.im + controller_B.d_data.im) -
        controller_B.t.im;
      controller_B.Gain = (controller_B.c_s.re + controller_B.c_s.im) / 8.64E+7;
      controller_B.DataStoreRead1_c = 0.0;
      controller_B.DataStoreRead8 = controller_B.b_c.re;
      if (controller_B.Gain != 0.0) {
        controller_B.DataStoreRead8 = controller_B.b_c.re + controller_B.Gain;
        controller_B.DataStoreRead1_c = controller_B.Gain -
          (controller_B.DataStoreRead8 - controller_B.b_c.re);
      }
      ...
      controller_B.d_ahi.re = controller_B.DataStoreRead8;
      ...
      controller_B.Gain = controller_B.b_c.re * 1000.0;
      controller_B.DataStoreRead1_c = (controller_B.t.re * 1000.0 -
        controller_B.Gain) + controller_B.t.im * 1000.0;
      trueCount = 0;
      if (rtIsNaN(controller_B.DataStoreRead1_c)) {
        trueCount = 1;
      }
      ...
      controller_B.c_s.re = 0.0;
      controller_B.c_s.im = 0.0;
      if (controller_B.d_data.re != controller_B.Gain) {
        controller_B.c_s = controller_two_diff(controller_B.d_data.re,
          controller_B.Gain);
      }
      ...
      controller_B.c_s.im = (controller_B.c_s.im + controller_B.d_data.im) -
        controller_B.DataStoreRead1_c;
      controller_B.Gain = (controller_B.c_s.re + controller_B.c_s.im) / 1000.0;
      controller_B.DataStoreRead1_c = 0.0;
      controller_B.DataStoreRead8 = controller_B.b_c.re;
      if (controller_B.Gain != 0.0) {
        controller_B.DataStoreRead8 = controller_B.b_c.re + controller_B.Gain;
      ...
      controller_B.d_data.re = controller_B.DataStoreRead8;
      ...
      controller_B.Gain = controller_B.t.re + controller_B.t.im;
      if ((controller_B.Gain >= 0.0) && (controller_B.Gain <= 2.147483647E+9)) {
        trueCount = (int32_T)rt_roundd_snf(controller_B.Gain);
        trueCount -= 3600 * div_s32(trueCount, 3600);
        controller_B.Gain = trueCount - 60 * div_s32(trueCount, 60);
      } else {
        controller_B.Gain -= floor((controller_B.Gain - floor(controller_B.Gain /
          3600.0) * 3600.0) / 60.0) * 60.0;
      }

      controller_B.DataStoreRead1_c = (controller_B.b_c.re + controller_B.b_c.im)
        + controller_B.Gain;
      if (controller_B.DataStoreRead1_c == 60.0) {
        controller_B.DataStoreRead1_c = 59.999999999999993;
      }
       ...
       */
      controller_B.Gain = controller_M->Timing.t[0];
      if ((controller_DW.TimeStampA >= controller_B.Gain) &&
          (controller_DW.TimeStampB >= controller_B.Gain)) {
        /* Derivative: '<S10>/Derivative' */
        controller_B.Derivative[0] = 0.0;
        controller_B.Derivative[1] = 0.0;
      } else {
        controller_B.DataStoreRead8 = controller_DW.TimeStampA;
        lastU = &controller_DW.LastUAtTimeA;
        if (controller_DW.TimeStampA < controller_DW.TimeStampB) {
          if (controller_DW.TimeStampB < controller_B.Gain) {
            controller_B.DataStoreRead8 = controller_DW.TimeStampB;
            lastU = &controller_DW.LastUAtTimeB;
          }
        } else if (controller_DW.TimeStampA >= controller_B.Gain) {
          controller_B.DataStoreRead8 = controller_DW.TimeStampB;
          lastU = &controller_DW.LastUAtTimeB;
        }
        ...
        /* Derivative: '<S10>/Derivative' */
        controller_B.Derivative[0] = (controller_B.Gain2[0] - (*lastU)[0]) /
          controller_B.DataStoreRead8;
        controller_B.Derivative[1] = (controller_B.Gain2[1] - (*lastU)[1]) /
          controller_B.DataStoreRead8;
      }
      ...
      /* Derivative: '<S10>/Derivative2' */
      if ((controller_DW.TimeStampA_g >= controller_B.Gain) &&
          (controller_DW.TimeStampB_j >= controller_B.Gain)) {
        /* Derivative: '<S10>/Derivative2' */
        controller_B.Derivative2[0] = 0.0;
        controller_B.Derivative2[1] = 0.0;
      } else {
        controller_B.DataStoreRead8 = controller_DW.TimeStampA_g;
        lastU = &controller_DW.LastUAtTimeA_o;
        if (controller_DW.TimeStampA_g < controller_DW.TimeStampB_j) {
          if (controller_DW.TimeStampB_j < controller_B.Gain) {
            controller_B.DataStoreRead8 = controller_DW.TimeStampB_j;
            lastU = &controller_DW.LastUAtTimeB_o;
          }
        } else if (controller_DW.TimeStampA_g >= controller_B.Gain) {
          controller_B.DataStoreRead8 = controller_DW.TimeStampB_j;
          lastU = &controller_DW.LastUAtTimeB_o;
        }
        ...
        /* Derivative: '<S10>/Derivative2' */
        controller_B.Derivative2[0] = (controller_B.Derivative[0] - (*lastU)[0])
          / controller_B.DataStoreRead8;
        controller_B.Derivative2[1] = (controller_B.Derivative[1] - (*lastU)[1])
          / controller_B.DataStoreRead8;
      }
       ...
       *  MATLAB Function: '<S10>/MATLAB Function'
       */
      controller_B.TmpSignalConversionAtCCalle[0] =
        controller_B.DataStoreRead1_c;
      controller_B.TmpSignalConversionAtCCalle[1] = controller_B.Derivative[0];
      controller_B.TmpSignalConversionAtCCalle[2] = controller_B.Derivative[1];
      controller_B.TmpSignalConversionAtCCalle[3] = controller_B.Derivative2[0];
      controller_B.TmpSignalConversionAtCCalle[4] = controller_B.Derivative2[1];

      /* DataTypeConversion: '<S10>/Data Type Conversion2' incorporates:
       *  Constant: '<S10>/Constant2'
       */
      controller_B.Gain = floor(controller_P.Constant2_Value);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
       ...
       */
      print_data(&controller_B.TmpSignalConversionAtCCalle[0], controller_B.Gain
                 < 0.0 ? -(int32_T)(uint32_T)-controller_B.Gain : (int32_T)
                 (uint32_T)controller_B.Gain);

      /* DataTypeConversion: '<S27>/Data Type Conversion1' incorporates:
       *  Constant: '<S10>/Constant'
       */
      controller_B.Gain = floor(controller_P.Constant_Value_i);
      if (rtIsNaN(controller_B.Gain) || rtIsInf(controller_B.Gain)) {
        controller_B.Gain = 0.0;
      } else {
        controller_B.Gain = fmod(controller_B.Gain, 4.294967296E+9);
    ...
    if (rtb_Compare_n1 && (controller_PrevZCX.ExitControl_Trig_ZCE != POS_ZCSIG))
    {
       ...
       */
      stop_motor(controller_DW.pdo_id, controller_B.Gain < 0.0 ? -(int32_T)
                 (uint32_T)-controller_B.Gain : (int32_T)(uint32_T)
                 controller_B.Gain);
...

  {
    ...
    if (controller_DW.Home2_MODE) {
      ...
      (*lastU)[0] = controller_B.Gain2_a[0];
      (*lastU)[1] = controller_B.Gain2_a[1];
    ...
    if (controller_DW.MainControl_MODE) {
      ...
      (*lastU)[0] = controller_B.Gain2[0];
      (*lastU)[1] = controller_B.Gain2[1];
      ...
      (*lastU)[0] = controller_B.Derivative[0];
      (*lastU)[1] = controller_B.Derivative[1];
