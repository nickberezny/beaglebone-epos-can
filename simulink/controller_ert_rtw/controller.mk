...
## Generated on : Fri Jul 14 20:39:56 2023
...
DEFINES_STANDARD = -DMODEL=controller -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = coder_posix_time.c controller.c controller_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c test_function.c init_can.c set_motor.c get_encoder.c print_input.c MW_bbblue_init.c linuxinitialize.c
...
OBJS = coder_posix_time.c.o controller.c.o controller_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o test_function.c.o init_can.c.o set_motor.c.o get_encoder.c.o print_input.c.o MW_bbblue_init.c.o linuxinitialize.c.o
...
test_function.c.o : test_function.c
	$(CC) $(CFLAGS) -o "$@" "$<"
